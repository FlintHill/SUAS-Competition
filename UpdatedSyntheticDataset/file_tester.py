...
image1 = TargetCreator.create_specified_single_target(31, "X", 500, 2, (255, 255, 255, 255), (0, 0, 0, 255))
image1.show()
image2 = TargetCreator.create_specified_single_target(32, "X", 500, 2, (255, 255, 255, 255), (0, 0, 0, 255))
image2.show()
image3 = TargetCreator.create_specified_single_target(6, "X", 500, 2, (255, 255, 255, 255), (0, 0, 0, 255))
image3.show()
image4 = TargetCreator.create_specified_single_target(8, "X", 500, 2, (255, 255, 255, 255), (0, 0, 0, 255))
image4.show()
