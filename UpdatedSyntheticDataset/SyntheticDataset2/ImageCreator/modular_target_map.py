...
class ModularTargetMap(object):
    ...
    def record_modular_target_map(self, index_number):
        data = {}
        data["targets"] = []
        ...
        with open(Settings.SAVE_PATH + Settings.ANSWERS_DIRECTORY + "/modular_target_maps_answers/" + str(index_number) + ".json", 'w') as outfile:
            json.dump(data, outfile, indent=4)
        self.background.save(Settings.SAVE_PATH + Settings.ANSWERS_DIRECTORY + "/modular_target_maps/" + str(index_number) + ".jpg")
