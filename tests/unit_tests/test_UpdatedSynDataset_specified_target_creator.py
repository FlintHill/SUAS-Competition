...
class SpecifiedTargetCreatorTestCase(unittest.TestCase):

    def setUp(self):
        self.test_image0 = SpecifiedTargetCreator.create_specified_target("circle","?", "A", 300, 1.5, (255, 255, 255, 255), (0, 255, 255, 255), 0, 0, 0)
        self.test_image1 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "N", "A", 300, 1.5, (255, 255, 255, 255), (0, 255, 255, 255), 0, 0, 0)
        self.test_image2 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "NE", "B", 300, 1.5, (255, 255, 255, 255), (0, 255, 255, 255), 0, 0, 0)
        self.test_image3 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "E", "C", 300, 1.5, (255, 255, 255, 255), (0, 255, 255, 255), 0, 0, 0)
        self.test_image4 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "SE", "D", 300, 1.5, (255, 255, 255, 255), (0, 255, 255, 255), 0, 0, 0)
        self.test_image5 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "S", "E", 400, 1.5, (0, 0, 0, 255), (255, 255, 255, 255), 0, 0, 0)
        self.test_image6 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "SW", "F", 400, 1.5, (0, 0, 0, 255), (255, 255, 255, 255), 0, 0, 0)
        self.test_image7 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "W", "G", 400, 1.5, (0, 0, 0, 255), (255, 255, 255, 255), 0, 0, 0)
        self.test_image8 = SpecifiedTargetCreator.create_specified_target("quarter_circle", "NW", "H", 400, 1.5, (0, 0, 0, 255), (255, 255, 255, 255), 0, 0, 0)
        self.test_image9 = SpecifiedTargetCreator.create_specified_target("half_circle", "N", "I", 500, 1.5, (255, 0, 0, 255), (0, 0, 0, 255), 0, 0, 0)
        self.test_image10 = SpecifiedTargetCreator.create_specified_target("half_circle", "E", "J", 500, 1.5, (255, 0, 0, 255), (0, 0, 0, 255), 0, 0, 0)
        self.test_image11 = SpecifiedTargetCreator.create_specified_target("half_circle", "S", "K", 500, 2, (255, 0, 0, 255), (0, 0, 0, 255), 0, 0, 0)
        self.test_image12 = SpecifiedTargetCreator.create_specified_target("half_circle", "W", "L", 500, 2, (255, 0, 0, 255), (0, 0, 0, 255), 0, 0, 0)
        self.test_image13 = SpecifiedTargetCreator.create_specified_target("cross", "N", "M", 600, 2, (0, 255, 0, 255), (255, 0, 0, 255), 0, 0, 0)
        self.test_image14 = SpecifiedTargetCreator.create_specified_target("cross", "D", "N", 600, 2, (0, 255, 0, 255), (255, 0, 0, 255), 0, 0, 0)
        self.test_image15 = SpecifiedTargetCreator.create_specified_target("triangle", "N", "O", 600, 2, (0, 255, 0, 255), (255, 0, 0, 255), 0, 0, 0)
        self.test_image16 = SpecifiedTargetCreator.create_specified_target("triangle", "S", "P", 600, 2, (0, 255, 0, 255), (255, 0, 0, 255), 0, 0, 0)
        self.test_image17 = SpecifiedTargetCreator.create_specified_target("square", "N", "Q", 700, 2, (0, 0, 255, 255), (0, 255, 0, 255), 0, 0, 0)
        self.test_image18 = SpecifiedTargetCreator.create_specified_target("square", "D", "R", 700, 2, (0, 0, 255, 255), (0, 255, 0, 255), 0, 0, 0)
        self.test_image19 = SpecifiedTargetCreator.create_specified_target("rectangle", "NS", "S", 700, 2, (0, 0, 255, 255), (0, 255, 0, 255), 0, 0, 0)
        self.test_image20 = SpecifiedTargetCreator.create_specified_target("rectangle", "EW", "T", 700, 2, (0, 0, 255, 255), (0, 255, 0, 255), 0, 0, 0)
        self.test_image21 = SpecifiedTargetCreator.create_specified_target("trapezoid", "N", "U", 800, 2, (255, 255, 0, 255), (0, 0, 255, 255), 0, 0, 0)
        self.test_image22 = SpecifiedTargetCreator.create_specified_target("trapezoid", "S", "V", 800, 2.5, (255, 255, 0, 255), (0, 0, 255, 255), 0, 0, 0)
        self.test_image23 = SpecifiedTargetCreator.create_specified_target("pentagon", "N", "W", 800, 2.5, (255, 255, 0, 255), (0, 0, 255, 255), 0, 0, 0)
        self.test_image24 = SpecifiedTargetCreator.create_specified_target("pentagon", "S", "X", 800, 2.5, (255, 255, 0, 255), (0, 0, 255, 255), 0, 0, 0)
        self.test_image25 = SpecifiedTargetCreator.create_specified_target("hexagon", "N", "Y", 900, 2.5, (255, 0, 255, 255), (255, 255, 0, 255), 0, 0, 0)
        self.test_image26 = SpecifiedTargetCreator.create_specified_target("hexagon", "D", "Z", 900, 2.5, (255, 0, 255, 255), (255, 255, 0, 255), 0, 0, 0)
        self.test_image27 = SpecifiedTargetCreator.create_specified_target("heptagon", "N", "A", 900, 2.5, (255, 0, 255, 255), (255, 255, 0, 255), 0, 0, 0)
        self.test_image28 = SpecifiedTargetCreator.create_specified_target("heptagon", "S", "B", 900, 2.5, (255, 0, 255, 255), (255, 255, 0, 255), 0, 0, 0)
        self.test_image29 = SpecifiedTargetCreator.create_specified_target("octagon", "N", "C", 1000, 2.5, (0, 255, 255, 255), (255, 0, 255, 255), 0, 0, 0)
        self.test_image30 = SpecifiedTargetCreator.create_specified_target("octagon", "D", "D", 1000, 2.5, (0, 255, 255, 255), (255, 0, 255, 255), 0, 0, 0)
        self.test_image31 = SpecifiedTargetCreator.create_specified_target("star", "N", "E", 1000, 2.5, (0, 255, 255, 255), (255, 0, 255, 255), 0, 0, 0)
        self.test_image32 = SpecifiedTargetCreator.create_specified_target("star", "S", "F", 1000, 2.5, (0, 255, 255, 255), (255, 0, 255, 255), 0, 0, 0)
