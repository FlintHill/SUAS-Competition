...
class TargetWithBackgroundCreatorTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_image1 = TargetWithBackgroundCreator.create_specified_target_with_specified_background("circle", "?", "A", 300, 1.5, (255, 255, 255, 255), (255, 0, 0, 255), self.path_to_background, 0, 0, 0)
        self.test_image2 = TargetWithBackgroundCreator.create_specified_target_with_specified_background("half_circle", "E", "E", 400, 1.75, (0, 255, 0, 255), (0, 0, 255, 255), self.path_to_background, 45, 0, 0)
        self.test_image3 = TargetWithBackgroundCreator.create_specified_target_with_specified_background("cross", "D", "I", 500, 2.0, (255, 255, 0, 255), (255, 0, 255, 255), self.path_to_background, 90, 0, 0)
        self.test_image4 = TargetWithBackgroundCreator.create_specified_target_with_specified_background("heptagon", "S", "O", 600, 2.25, (0, 255, 255, 255), (0, 0, 0, 255), self.path_to_background, 135, 0, 0)
        self.test_image5 = TargetWithBackgroundCreator.create_specified_target_with_specified_background("star", "N", "U", 700, 2.5, (66, 66, 66, 255), (233, 233, 233, 255), self.path_to_background, 180, 0, 0)
