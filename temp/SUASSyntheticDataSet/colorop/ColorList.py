...
from colorop.ColorMath import ColorMath
class ColorList:
    ...
    def __init__(self):
        ...
        ColorList.namedColors.append(ColorList.Color('brown', (236,204,132,255)))#sample targets have a really bad looking brown that seems more orangey
