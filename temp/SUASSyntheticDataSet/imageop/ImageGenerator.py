...
from imageop.FieldObject import CompassAngler
from colorop.ColorList import ColorList
import string
from imageop.PolyPic import PolyPic
...
class ImageGenerator:
    ...
    def __init__(self):
        self.polyPics = []
        self.grassLoader = ImageLoader("/Users/phusisian/Documents/workspace2/SUASSyntheticDataSet/Images/Grass")
        
        
    '''def getRandomlyGeneratedImg(self):
