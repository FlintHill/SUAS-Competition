...
from imageop.ImageCropper import ImageCropper
from imageop.ImageBounder import ImageBounder
...
class FieldObject:
    ...
    def setObjectLetter(self, letter):
        ...
        self.objectLetter = ObjectLetter(self, letter,"/Users/phusisian/Documents/workspace2/SUASSyntheticDataSet/fonts/Blockletter.otf", randomHeight)#eventually replace the letter size with a method that gets a random height within reasonable bounds
