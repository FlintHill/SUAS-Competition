...
class SobelEdge:
    ...
    def init_gradients(self):
        self.gradient_x = KernelMath.convolute_array(self.img, SobelEdge.SOBEL_KERNEL_X)
        self.gradient_y = KernelMath.convolute_array(self.img, SobelEdge.SOBEL_KERNEL_Y)
