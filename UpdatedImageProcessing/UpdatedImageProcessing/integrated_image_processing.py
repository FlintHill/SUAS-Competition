...
class IntegratedImageProcessing(object):
    ...
    @staticmethod
    def run_integrated_image_processing(source_image_path, crop_save_path):
        target_detected = []
        target_map_path = source_image_path
        autonomous_image_processing_save_path = crop_save_path
