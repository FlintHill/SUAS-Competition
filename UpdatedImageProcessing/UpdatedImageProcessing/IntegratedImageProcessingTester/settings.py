...
class Settings(object):
    ...
    TARGET_MAP_PATH = os.path.expanduser("~/Desktop/manual_dataset/target_maps")
    ...
    TARGET_MAP_ANSWER_SHEET_PATH = os.path.expanduser("~/Desktop/manual_dataset/target_maps_answers")
