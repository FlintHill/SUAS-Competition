...
root = "http://" + server + ".tile.openstreetmap.org/" # {z}/{x}/{y} !!!!!!!!!!!
...
"""
test_url = "http://a.tile.openstreetmap.org/0/0/0.png" # !!!!!!!!!!!!!!!!!!!!!!!

print("Making test download: " + test_url + "...")

download_file(test_url, "tile/0/0/")

print("Checking file...")

if os.path.isfile("tile/0/0/0.png"):
  print("HTTP_SUCCESS: Download successfully!")
else:
  print("HTTP_FAILURE: Download failed, unknown reason")
  sys.exit("---see above error: line 111")
"""
...
phase  = zoom_start # default: 0 also zoom level !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
extend = 1 # int(zoom_start**1.0) + 1 # default: 0 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
count  = 0

print(" !!! PHASE IS " + str(phase))

for phase in reversed(range(0, phase)):
  extend = int(phase**1.2) + 1 # default: 0 !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#point = deg2num(38.8702, -77.3157, 15)
#print point[0]
#print point[1]